package com.mif50.extensions.ktx.file
...
import com.mif50.extensions.ktx.ifNotNull
...
object FileKtx {
     ...
     */
    fun isLocal(url: String?): Boolean = url != null && !url.startsWith("http://") && !url.startsWith("https://")
    ...
    fun getMimeType(context: Context, uri: Uri?): String? {
        ifNotNull(uri,getPath(context, uri!!)) { _, path ->
            val file = File(path)
        ...
        if (DocumentsContract.isDocumentUri(context, uri)) {
            ...
            if (isLocalStorageDocument(uri)) {
                ...
                when (type) {
                    ...
                    "videosList" -> contentUri = MediaStore.Video.Media.EXTERNAL_CONTENT_URI
        ...
        if (uri != null) {
            ...
            try {
                ...
                if (cursor!!.moveToFirst()) {
                    ...
                    if (mimeType!!.contains("videosList")) {
                        bm = MediaStore.Video.Thumbnails.getThumbnail(
                            resolver,
                            id.toLong(),
                            MediaStore.Video.Thumbnails.MINI_KIND, null
                        )
                    } else if (mimeType.contains(FileKtx.MIME_TYPE_IMAGE)) {
